...
def init_model(train):
    ...
    with tf.device('/device:GPU:1'):
        ...
        if train:
            ...
            iterator = get_dataset_iterator(file_paths, 100, shuffle=False)
        
        #print("This is what the iterator is " + str(iterator))
        
        # Get color image
        color_image_rgb, names = iterator.get_next(name="color_image_rgb")
    ...
    return is_training, global_step, optimizer, loss, predict_rgb, color_image_rgb, gray_image_three_channels, file_paths, names
